...
const LipSection = ({ setIsRegisterView }) => {
    ...
    // helper: match image path ทั้ง "lip_1.1.jpg" และ "products/lip_1.1.jpg"
    ...
    return (
        <>
      	...
      	<section className="product-categories-section">
            ...
            {/* LIP Section Header (no plus icon) */}

            <section className="section-header-lip">
                <div className="header-container">
                    <h2 className="section-title">LIP</h2>
                </div>
            </section>

            {/* Filter Sidebar (Availability, Price) */}
            <div className="lip-content-layout">
                    ...
                    <div className="filter-group">
                        ...
                        {priceOpen && (
                            <div className="filter-price-section">
                                ...
                                <div className="lip-grid" style={{ margin: '0 0 64px 0' }}>
                                    {(() => {
                                        const REGEX = /^lip_(\d+)\./i;
                                        ...
                                        const groupedCards = groupNums.map(num => {
                                            ...
                                            return (
                                                <div className="lip-card" key={`g_${num}`}>
                                ...
                                {product.Product_model && <div className="card-model">{product.Product_model}</div>}
                                                        ...
                                                        {colors.length > 0 && (
                                                        <div className="card-colors" style={{ marginBottom: '6px' }}>
                                                          <div style={{ display: 'flex', gap: '8px' }}>
                                                            {colors.slice(0, 7).map((item, i) => (
                                                              <span
                                                                key={i}
                                        ...
                                        const standaloneCards = standaloneProducts.map(product => {
                                            ...
                                            return (
                                                <div className="lip-card" key={`s_${product.Product_id}`}>
                                                    <a href={`/best1/${product.Product_id}`} style={{textDecoration:'none', position:'relative', display:'block'}}>
                                                        <div className="card-image" style={{
                                                            backgroundImage: `url(${imgSrc})`,
                                                            width: '180px', height: '180px',
